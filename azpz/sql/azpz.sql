...
# Neue Datenbank erzeugen klappte hier (@home) nicht, dehalb bitte in exitiereder
# DB azpz ausführen oder code Zeile 12 wieder einkommwntieren
...
USE `azpz`;
 ...
 DELIMITER //
CREATE OR REPLACE FUNCTION table_exits ( `ptable_name` VARCHAR(30)) RETURNS INT
  BEGIN    
    RETURN (SELECT COUNT(*)    
